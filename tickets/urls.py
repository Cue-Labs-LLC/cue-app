...
urlpatterns = [
    ...
    path('events/<uuid:event_id>/conversion/', views.event_conversion_api, name='event_conversion_api'),
    ...
    path('events/<uuid:event_id>/images/', views.event_image_upload, name='event_image_upload'),
    path('events/<uuid:event_id>/images/reorder/', views.event_image_reorder, name='event_image_reorder'),
    path('events/<uuid:event_id>/images/<uuid:image_id>/delete/', views.event_image_delete, name='event_image_delete'),
